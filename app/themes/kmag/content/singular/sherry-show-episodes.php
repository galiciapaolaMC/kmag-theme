<?php
/**
 * The template used for displaying th Sherry Show Episode
 *
 * @package CN
 */
...
<article id="post-<?php the_ID(); ?>" class="sherry-show-episode" data-post-type="sherry-show-episode">
    <div class="sherry-show-episode__container">
        <div class="uk-container uk-container-large">
            <h1 class="sherry-show-episode__title"><?php echo esc_html($episode_title); ?></h1>

            <?php if (!empty($episode_description)) { ?>
                <div class="sherry-show-episode__description">
                    <?php echo wpautop($episode_description); ?>
                </div>
            <?php } ?>
        
            <?php if (!empty($episode_link)) { ?> 
                <div class="sherry-show-episode__video">
                                        ...
                                        <div class="uk-grid uk-grid-medium uk-grid-match" uk-grid>
                                            ...
                                            <div class="uk-width-1-2@m uk-width-1-1@s">
                                                <div class="split-banner__content-container font-color-black">
                                                    <p><?php echo esc_html($season); ?> <?php _e('| Episode ', 'kmag'); ?> <?php echo esc_html($episode_number); ?></p>
                                                    <h2 class="headline"><?php echo esc_html($episode_title ); ?></h2>
                                                    <a href="<?php echo esc_url($episode_link); ?>" class="btn btn--small btn--secondary"><?php _e('< Play Previous Episode', 'kmag'); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-grid uk-grid-medium uk-grid-match" uk-grid>
                                            <div class="uk-width-1-2@m uk-width-1-1@s">
                                                <div class="split-banner__content-container font-color-black">
                                                    <p><?php echo esc_html($season); ?> <?php _e('| Episode ', 'kmag'); ?> <?php echo esc_html($episode_number); ?></p>
                                                    <h2 class="headline"><?php echo esc_html($episode_title ); ?></h2>
                                                    <a href="<?php echo esc_url($episode_link); ?>" class="btn btn--small btn--secondary"><?php _e('Play Next Episode >', 'kmag'); ?></a>
                                                </div>
                                            </div>
            ...
            <?php if (!empty($associated_farmers)) { ?>
                <div class="sherry-show-episode__farmers">
                    <h2 class="sherry-show-episode__farmers-title"><?php _e('Meet the Frontier Fields Farmers In this Episode', 'kmag'); ?></h2>
