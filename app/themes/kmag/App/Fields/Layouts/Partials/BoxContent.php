 ...
 */
class BoxContent extends Layouts
{
    /**
    ...
    public function fields()
    {
        return apply_filters(
            'cn/layout/box-content',
            Layout::make(__('Box Content', 'kmag'), 'box-content')
                ->layout('block')
                ->fields([
                    $this->contentTab(),
                    Image::make(__('Image', 'kmag'), 'box-image')
                        ->previewSize('thumbnail')
                        ->wrapper([
                            'width' => '50'
                        ]),
                    Image::make(__('Mobile Image', 'kmag'), 'box-image-mobile')
                        ->previewSize('thumbnail')
                        ->wrapper([
                            'width' => '50'
                        ]),
                    Textarea::make(__('Headline', 'kmag'), 'box-headline')
                        ->instructions(__(FORMATTING_TAG_INSTRUCTIONS, 'kmag'))
                        ->rows(2),
                    WysiwygEditor::make(__('Paragraph', 'kmag'), 'box-paragraph')
                        ->mediaUpload(false)
                        ->toolbar('simple'),
                    Link::make(__('Button', 'kmag'), 'box-button'),
                    $this->optionsTab(),
