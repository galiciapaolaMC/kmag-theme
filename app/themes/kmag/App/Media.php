...
class Media implements WordPressHooks
{
    ...
    /**
     * Retrieve an image's alt text by attachment ID
     *
     * @param number $attachment_id
     *
     * @return null|string
     ...
     * @since 3.1.7
     */
    public static function getAttachmentAltByID($attachment_id)
    {
        $attachment = self::getAttachmentByID($attachment_id);
    ...
    /**
     * Retrieve a file's src by attachment ID
     *
     * @param number $attachment_id
     *
     * @return null|string
     ...
     * @since 3.1.7
     */
    public static function getPdfSrcByID($attachment_id)
    {
        $attachment = self::getAttachmentByID($attachment_id);
