...
class Taxonomies
{
    ...
    public static function registerTaxonomy($slug, $singular, $plural, $types = [], $args = [])
    {
        $labels = [
            ...
            'all_items'         => sprintf(__('All %1$s', 'kmag'), $plural),
            'parent_item'       => sprintf(__('Parent %1$s', 'kmag'), $singular),
            'parent_item_colon' => sprintf(__('Parent %1$s:', 'kmag'), $singular),
            'edit_item'         => sprintf(__('Edit %1$s', 'kmag'), $singular),
            'update_item'       => sprintf(__('Update %1$s', 'kmag'), $singular),
            'add_new_item'      => sprintf(__('Add New %1$s', 'kmag'), $singular),
            'new_item_name'     => sprintf(__('New %1$s Name', 'kmag'), $singular)
        ];
