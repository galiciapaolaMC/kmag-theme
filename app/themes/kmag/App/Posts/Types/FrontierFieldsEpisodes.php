 ...
 */
class FrontierFieldsEpisodes implements WordPressHooks
{
    /**
     * Add class hooks.
     */
    ...
    public function registerPost()
    {
        PostTypes::registerPostType(
            // wordpress requries length of post slug be less than 20 characters
            'frontier-fields-eps',
            __('Frontier Fields Episode', 'kmag'),
            __('Frontier Fields Episodes', 'kmag'),
            [
        ...
        Taxonomies::registerTaxonomy(
            'episode-type',
            __('Episode Type', 'kmag'),
            __('Episode Types', 'kmag'),
            ['frontier-fields-eps'],
            [
                'hierarchical' => false,
    ...
    public function customTaxonomyCheckboxes($post, $box)
    {
        ...
        <div class="taxonomy-box">
            <p><strong><?php esc_html_e('Select Option', 'kmag'); ?></strong></p>
