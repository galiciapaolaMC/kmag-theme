<?php
/**
 * Template Name: Retail Calculator Page Builder
 *
...
<main class="retail-calculator-container super-link-entry-point <?php echo $gated_content_class; ?>" id="primary-retail" <?php echo $campaign_action_attr; ?> <?php echo $score_action_attr; ?>>
    <?php
