...
$sub_heading = ACF::getField('card-sub-headline', $data);

$has_sub_heading = ! empty($sub_heading);
...
<div class="module card <?php echo esc_attr($card_size_class); ?>">
    ...
    <div class="card__figure <?php echo $desktop_rounding_classes?>" style="<?php echo $desktop_image_styles ?>"
        aria-label="<?php echo $image_alt ?>"></div>
    <div class="card__figure-mobile <?php echo $mobile_rounding_classes?>" style="<?php echo $mobile_image_styles ?>"
        aria-label="<?php echo $image_alt ?>"></div>
    <?php } ?>

    <?php if ($has_heading || $has_text_content || $has_button || $has_sub_heading) { ?>
    <div class="card__content">
        <?php 
            ...
            if ($has_sub_heading) {
                ?>
        <h4 class='card__subheading' style="margin-bottom: 18px; font-weight: 600;"><?php echo $sub_heading; ?></h4>
